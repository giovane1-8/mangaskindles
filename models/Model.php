<?php
    ...
    class Model{
        ...
        function __construct(){
            ...
            try {
                $this -> PDO = new \PDO('pgsql:host=ec2-3-233-100-43.compute-1.amazonaws.com:5432;dbname=dd741ac9mgmg6b', $username, $password, array(\PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
