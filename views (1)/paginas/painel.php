    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input onclick="submitForm();" type="button" class="btn btn-primary mx-auto darkmode-ignore" value="Recortar">
            </div>
        </div>
    </div>
</div>
<div class="row card-deck mt-3">
    ...
    <figure class="figure mx-auto">
        ...
        <div class="d-flex justify-content-around mx-auto">
            ...
            <input type="button" onclick="submitForm();" class="btn btn-primary darkmode-ignore" value="Atualizar">

            <?php
            if (substr($_SESSION["nm_caminho_foto"], -11) != "default.png") {
                echo "<form action='painel/excluirfoto' method='POST'>
