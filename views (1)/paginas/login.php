...
<div class=" d-flex">
    <form class="col" method="post" action="#">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="usuario" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Seu email ou nickname" value="<?php if (isset($_SESSION["usuario"])) {
