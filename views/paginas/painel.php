    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="hidden" onclick="submitForm();" value="Recortar">
            </div>
        </div>
    </div>
</div>
<div class="row card-deck mt-3">
    ...
    <figure class="figure mx-auto">
        <label class for="arquivo" style="cursor: pointer;">
            <img id="imagem" src="<?php echo VENDOR_PATH . $_SESSION['nm_caminho_foto']; ?>" class="figure-img col  img-fluid rounded">
            <center><input type="submit" onclick="submitForm();" class="btn btn-primary mx-auto darkmode-ignore" id="sendButton" value="Atualizar"></center>
        </label>
